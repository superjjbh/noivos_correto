                            ...
                            <?php foreach ($pagina->db->data as $listar): ?>
                                <div class="col-md-3">
                                    <div class="gallery-item rounded shadow">
                                        ...
                                        <a href="javascript:void(0);" style="cursor:default" class="gallery-img"><img src="thumb.php?w=600&h=400&zc=1&src=../images/blog/<?= $listar->pagina_imagem ?>" class="img-responsive full-width" alt="..." /></a>
                                        <br />
                                        <div class="gallery-author">
                                            <div class="media">
                                                <div class="media-body text-center">
                                                    <h4 class="media-heading text-capitalize">Presente: <?= stripslashes($listar->pagina_nome) ?> </h4>
                                                    <h4 class="media-heading text-capitalize"><b> Valor: R$ <?= stripslashes($listar->pagina_autor) ?></b></h4>
													<p><span class="text-capitalize">Categoria: <?= stripslashes($listar->area_nome)?></span></p>
                                                </div>
                                            </div>
                                        </div>
