...
$fornecedores->db = new DB;
$fornecedores->db->url = "fornecedor";
$fornecedores->db->paginate(12);
        ...
        <section id="wrapper" class="page-sound">
            ...
            <section id="page-content">
                <div class="header-content">
                    <h2><i class="fa fa-truck"></i> <span>Fornecedores</span></h2>
                ...
                <div class="body-content animated fadeIn">
                    <ul class="col-md-12 row" >
                        <?php if (isset($fornecedores->db->data[0])): ?>
                            <?php foreach ($fornecedores->db->data as $listar): ?>
                                <div class="col-md-3">
                                    <div class="gallery-item rounded shadow">
                                        <span class="gallery-love">
                                            <i class="fa fa-heart-o"></i>
                                        </span>
                                        <a href="javascript:void(0);" style="cursor:default" class="gallery-img"><img src="thumb.php?w=600&h=400&zc=1&src=../images/team/<?= $listar->fornecedor_imagem ?>" class="img-responsive full-width" alt="..." /></a>
                                        <br />
                                        <div class="gallery-author">
                                            <div class="media">
                                                <div class="media-body text-center">
                                                    <h3 class="media-heading text-capitalize"> <?= stripslashes($listar->fornecedor_nome) ?> </h3>
													<h4 class="media-heading text-capitalize"> <?= stripslashes($listar->fornecedor_subtitulo) ?> </h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="gallery-details">
                                            <div class="text-center">
                                                <a class="btn btn-circle btn-info atualizar"  href="fornecedor/editar/<?= $listar->fornecedor_id ?>/">
                                                    <i class="fa fa-edit icon-white"></i>
                                                </a>
                                                <a class="btn btn-circle btn-danger delete" data-url="fornecedor_fn.php?acao=remover&AMP;id=<?= $listar->fornecedor_id ?>">
...
<?php endif; ?>
            $('.listarfornecedores').addClass('active');
