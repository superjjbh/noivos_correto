        ...
        <section id="wrapper" class="page-sound">
            ...
            <section id="page-content">
                <div class="header-content">
                    <h2><i class="fa fa-suitcase"></i> <span>Destaques Cadastrados</span></h2>
                        ...
                        <div class="col-md-12">
                            <div class="panel rounded shadow">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h3 class="panel-title"><a class="btn btn-primary" href="servico/novo/"  style="color:#fff"><i class="fa fa-plus-circle" ></i> Novo Destaque</a></h3>
                                    </div>
