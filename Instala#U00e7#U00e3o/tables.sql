...
(1, 'falecom@phpstaff.com.br', '(13) 3356-9312', 'Av São Paulo,  200 - Praia Grande - SP', '-24.0117710,-46.4177888', '', '(11) 971-369-596 Vivo', '', '', '');
...
(1, 'Seja bem-vindo ao SEATTLE - Template com 10 Cores + Admin', 'Mais um template premium com painel administrativo customizado por PHP Staff.', 1);
...
(1, 'Onde estamos? clique no mapa', 'Seu Site Â© 2014 All Rights Reserved. Designed by PHP Staff');
...
(1, 'blue', 'favicon.ico', '1434835644.png');
...
(1, 'Template premium com 10 cores + Painel admin - PHP e Bootstrap Download', 'template admin, php admin, phpstaff, cÃ³digo php, gerenciador de conteÃºdo php', 'PHP Staff - Template Admin', NULL, 'sobre', 'logo-small.png', 'PHP Staff', 'parallax_bg11.jpg', 'UA-123456-7');
...
(21, '1432396240.jpg', 'Template Premium Com 10 Cores + Admin', 'Design limpo, responsivo e inteligente', 'Desenvolvido por PHP Staff para nossos Parceiro!'),
(22, '1434836834.jpg', 'Template Premium Com 10 Cores', 'Design limpo, responsivo e inteligente', 'Customizado por PHP Staff para nossos parceiros!');
...
(13, 'PHP Staff', 'admin', 'falecom@phpstaff.com.br', '21232f297a57a5a743894a0e4a801fc3', '08/04/2015', '1432663838.jpg');
