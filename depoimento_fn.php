...
function incluir() {
    ...
    $depoimento_status = addslashes($_POST['depoimento_status']);
    ...
    $depoimento->depoimento_status = $depoimento_status;
...
function atualizar() {
    ...
    $atualizar->depoimento_status = addslashes($_POST['depoimento_status']);
