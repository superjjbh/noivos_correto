...
--
-- Host: 127.0.0.1
-- Generation Time: 08-Dez-2017 às 06:05
...
(1, 'superjjbh@gmail.com', '', 'Rua Ernesto Tognolo - Belo Horizonte/MG', '-19.8580209,-43.8909095', '(31) 98640-7398', '(31) 8640-7398  (WhattsApp)', '', '', '59d68ba84854b82732ff3de2');
...
(215, '05bd9013c27434d76ea822c26de71a70.jpg', 0, 73),
(216, '03055c5d74c2033785d2b9b3abe62d5e.jpg', 0, 73);
...
(1, 'Seja bem-vindo ao Site PadrÃ£o J&M 2.0 - Site Completo + Painel de Controle', 'Por apenas R$ 60,00 por mÃªs, vocÃª terÃ¡ o seu site institucional completo', 1);
...
(1, 'Home', 'Sobre NÃ³s', 'PortfÃ³lio', 'Blog', 'Contato', 'Blog', 'Price', 'Blog', 'Contato', 1);
...
(1, 'Onde estamos? clique no mapa', 'Seu Site Â© 2017 All Rights Reserved. Desenvolvido por J&M Tecnologia');
...
(1, 'blue', 'favicon.ico', '1510976167.png', 'bwide');
...
(2, 'Atendimento RÃ¡pido', 'fa fa-whatsapp', 'Entre em contato pelo noo Whatapp 98640-7398'),
...
(1, 'Template premium com 10 cores + Painel admin - PHP e Bootstrap', 'template admin, php admin, cÃ³digo php, gerenciador de conteÃºdo php', 'J&M Site Institucional - J&M Tecnologia', NULL, 'sobre', 'logo-small.png', 'J&M Tecnologia', 'parallax_bg11.jpg', 'UA-35826732-1');
...
(18, '1510791904.jpeg', 'Com 10 Cores para personalizar o Seu Site', 'J&M Tecnologia', ''),
(20, '1510791799.jpg', 'Seu Site com Painel Admin Completo', 'J&M Tecnologia', '');
...
--
ALTER TABLE `comentario`
  MODIFY `comentario_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
--
...
--
ALTER TABLE `pagina`
  MODIFY `pagina_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
--
