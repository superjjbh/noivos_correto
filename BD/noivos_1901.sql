...
--
-- Host: 127.0.0.1
-- Generation Time: 19-Jan-2018 às 05:18
...
(10, 'Ram', 'Fundadora', 'Lacus lundium cursus ridiculus? Ridiculus tempor penatibus integer dolor eros scelerisque facilisis elit proin, magnis cursus facilisis mauris, et facilisis! Aliquet turpis amet, sit sagittis ac nec p', '1454588388.jpg'),
...
CREATE TABLE `depoimento` (
  ...
  `depoimento_status` varchar(4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `depoimento` (`depoimento_id`, `depoimento_nome`, `depoimento_cargo`, `depoimento_sobre`, `depoimento_data`, `depoimento_imagem`, `depoimento_status`) VALUES
...
(1, 'Home', 'Sobre Nós', 'Álbum de Fotos', 'Lista de Presentes', 'RSVP', 'Blog', 'Price', 'Blog', 'Contato', 1);
...
(1, 'A vida é minha. Mas o coração é seu. O sorriso é meu. Mas o motivo, é você.', 'parallax-3.jpg', 1);
...
(1, 'Nossa Lista de Presentes !', 'Presentei os noivos e pague em até 12x pelo Pagseguro.', '', 'ComentÃ¡rios', 'leia mais', '1', NULL, 12);
...
CREATE TABLE `padrinho` (
  ...
  `padrinho_nome` varchar(200) DEFAULT NULL,
  `padrinho_subtitulo` varchar(200) DEFAULT NULL,
  `padrinho_descricao` text NOT NULL,
  `padrinho_imagem` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `padrinho` (`padrinho_id`, `padrinho_nome`, `padrinho_subtitulo`, `padrinho_descricao`, `padrinho_imagem`) VALUES
(11, 'Smith', 'Developer', 'Lacus lundium cursus ridiculus? Ridiculus tempor penatibus integer dolor eros scelerisque facilisis elit proin, magnis cursus facilisis mauris, et facilisis! Aliquet turpis amet, sit sagasdfasdfffffas', '1432229684.jpg'),
(12, 'Peter', 'Designer', 'in! Vut velit? Ac pulvinar cursus et dis natoque dis! Sagittis nec nunc, proin ut amet? Enim, cum etiam et odio elementum parturient! Porta est aliquam arcu nascetur', '1432229718.jpg'),
(14, 'Lammego', 'Locutor/Produtor', 'asdfasfasfasfasdfafaaaaaaaaaaaaaaaaaaaaasadfasfasfasf', '1516287434.jpg'),
(15, 'teste', 'teste', 'esegsdg', '1516287137.jpg');
...
--
-- Indexes for table `padrinho`
--
ALTER TABLE `padrinho`
  ADD PRIMARY KEY (`padrinho_id`);
...
--
ALTER TABLE `depoimento`
  MODIFY `depoimento_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
-- AUTO_INCREMENT for table `padrinho`
--
ALTER TABLE `padrinho`
  MODIFY `padrinho_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
